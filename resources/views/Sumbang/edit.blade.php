              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  ...
                  <div class="detailbuku">
                    <form action="{{ route('Sumbang.update', ['id' => $sumbangan->id])}}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <form action="{{ route('Sumbang.delete', ['id' => $sumbangan->id]) }}" method="post" onsubmit="return confirm('Apa kamu yakin untuk menghapus?');">
                            @method('DELETE')
                            @csrf
