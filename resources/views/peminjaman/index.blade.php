    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{ route('peminjaman') }}">Daftar Peminjaman</a></li>
        </ol>
      </nav>
            ...
            <div class="card-body pb-0">
              ...
              <?php $no=1; ?>
                  ...
                  <tr>
                    ...
                    @endif
                    <a href="{{ url('peminjaman/delete/'.$rs->id)}}" class="btn btn-danger text-white">Hapus</a>
                    </td>
                  </tr>
                  @endforeach
            @else
                <tr>
                    <td class="text-center" colspan="6">Transaction not found</td>
                </tr>
            @endif
               </tbody>
    </table>
...
<div class="modal" tabindex="-1" role="dialog" id="editDataModal{{$v->id}}">
    <div class="modal-lg modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form to add data -->
                <form id="editDataForm" action="<?= url("peminjaman/update") ?>" method="POST">
                @csrf
                    <input type="hidden" name="myid" id="myid" value="{{ $v->id }}">
                    <div class="form-group" style="margin-top:10px">
                        <label for="judulBuku">Buku</label>
